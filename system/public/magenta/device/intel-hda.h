...
#define IHDA_INVALID_TRANSACTION_ID ((uint32_t)0)
...
// Request buffer for controllers
typedef union ihda_controller_req_buffer {
    ihda_cmd_hdr_t                      hdr;
    ihda_get_ids_req_t                  get_ids;
    ihda_controller_snapshot_regs_req_t snapshot_regs;
} ihda_controller_req_buffer_t;
...
// Aliases for codec request/response structures
