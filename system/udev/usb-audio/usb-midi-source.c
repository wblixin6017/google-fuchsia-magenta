...
static ssize_t usb_midi_source_read(void* ctx, void* data, size_t len, mx_off_t off) {
    usb_midi_source_t* source = ctx;
...
static ssize_t usb_midi_source_ioctl(void* ctx, uint32_t op, const void* in_buf,
