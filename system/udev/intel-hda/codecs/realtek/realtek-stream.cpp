...
mx_status_t RealtekStream::BeginChangeStreamFormatLocked(const Audio2StreamSetFmtReq& fmt) {
    ...
    if ((fmt.packing != AUDIO2_BIT_PACKING_16BIT_LE) &&
        (fmt.packing != AUDIO2_BIT_PACKING_20BIT_IN32_LE) &&
        (fmt.packing != AUDIO2_BIT_PACKING_24BIT_IN32_LE))
        return ERR_NOT_SUPPORTED;
