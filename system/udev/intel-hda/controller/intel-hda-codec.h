...
private:
    ...
    mx_status_t ProcessGetIDs(DriverChannel& channel, const ihda_proto::GetIDsReq& req)
        TA_REQ(process_lock());
    mx_status_t ProcessSendCORBCmd(DriverChannel& channel, const ihda_proto::SendCORBCmdReq& req)
        TA_REQ(process_lock());
    mx_status_t ProcessRequestStream(DriverChannel& channel,
                                     const ihda_proto::RequestStreamReq& req)
        TA_REQ(process_lock());
    mx_status_t ProcessReleaseStream(DriverChannel& channel,
                                     const ihda_proto::ReleaseStreamReq& req)
        TA_REQ(process_lock());
    mx_status_t ProcessSetStreamFmt(DriverChannel& channel, const ihda_proto::SetStreamFmtReq& req)
        TA_REQ(process_lock());
