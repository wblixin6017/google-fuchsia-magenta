...
mx_status_t IntelHDACodec::ProcessGetIDs(DriverChannel& channel, const ihda_proto::GetIDsReq& req) {
...
mx_status_t IntelHDACodec::ProcessSendCORBCmd(DriverChannel& channel,
...
mx_status_t IntelHDACodec::ProcessSetStreamFmt(DriverChannel& channel,
