...
void usb_hid_cleanup_instance(usb_hid_dev_instance_t* dev) {
    // Assume the root has already cleaned us up?
    // TODO: figure this out
    free(dev);
}

static input_report_size_t usb_hid_get_report_size_by_id(usb_hid_dev_root_t* hid,
...
static mx_status_t usb_hid_get_protocol(usb_hid_dev_root_t* hid, void* out_buf, size_t out_len) {
...
static mx_status_t usb_hid_get_hid_desc_size(usb_hid_dev_root_t* hid, void* out_buf, size_t out_len) {
...
static mx_status_t usb_hid_get_hid_desc(usb_hid_dev_root_t* hid, void* out_buf, size_t out_len) {
...
static mx_status_t usb_hid_get_num_reports(usb_hid_dev_root_t* hid, void* out_buf, size_t out_len) {
    if (out_len < sizeof(size_t)) return ERR_INVALID_ARGS;
...
static mx_status_t usb_hid_get_report_ids(usb_hid_dev_root_t* hid, void* out_buf, size_t out_len) {
...
static mx_status_t usb_hid_get_report_size(usb_hid_dev_root_t* hid, const void* in_buf, size_t in_len,
...
static mx_status_t usb_hid_get_max_reportsize(usb_hid_dev_root_t* hid, void* out_buf, size_t out_len) {
    if (out_len < sizeof(int)) return ERR_INVALID_ARGS;
...
static mx_status_t usb_hid_get_report(usb_hid_dev_root_t* hid, const void* in_buf, size_t in_len,
                                      void* out_buf, size_t out_len) {
...
static mx_status_t usb_hid_set_report(usb_hid_dev_root_t* hid, const void* in_buf, size_t in_len) {
