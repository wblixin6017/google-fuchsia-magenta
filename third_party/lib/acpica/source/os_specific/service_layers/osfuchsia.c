...
#define PCIE_EXTENDED_CONFIG_SHIFT 12
        ...
        //uint8_t bus_end = table_start->EndBusNumber;
        ...
        mx_handle_t h = mx_mmap_device_memory(root_resource_handle, base, ecam_size, MX_CACHE_POLICY_UNCACHED_DEVICE, (uintptr_t *)&ecam);
        if (h < 0)
            return AE_ERROR;
